...
declare const window: Window & { RTCMultiConnection: any };
export default defineComponent({
  ...
  mounted() {
    ...
    connection.connectSocket(function (socket: { on: (arg0: string, arg1: () => void) => void; }) {
      looper();
    ...
    function looper() {
      ...
      connection.socket.emit('get-public-rooms', publicRoomIdentifier, function (listOfRooms: any) {
